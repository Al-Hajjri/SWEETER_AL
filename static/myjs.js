...
function check_dup() {
  ...
  if (!is_nickname(username)) {
    $("#help-id")
      .text(
        "Silakan periksa identitas anda.Silakan masukkan 2-10 karakter bahasa Inggris, angka, atau karakter khusus berikut (._-)"
      )
      .removeClass("is-safe")
      .addClass("is-danger");
    $("#input-username").focus();
...
function sign_up() {
  ...
  if ($("#help-id").hasClass("is-danger")) {
    alert("Silakan periksa identitas Anda");
    return;
  } else if (!$("#help-id").hasClass("is-success")) {
    alert("Silakan periksa kembali identitas Anda");
    return;
  }
  ...
  if (password === "") {
    ...
    $("#help-password")
      .text(
        "Silakan periksa kata sandi anda. Untuk kata sandi anda, silakan masukkan 8-20 karakter bahasa Inggris, angka, atau karakter khusus berikut (!@#$%^&*)"
      )
      .removeClass("is-safe")
      .addClass("is-danger");
    $("#input-password").focus();
  ...
  if (password2 === " ") {
    $("#help-password2")
      .text("Silakan masukkan kata sandi anda lagi")
      .removeClass("is-safe")
      .addClass("is-danger");
  ...
  $.ajax({
    ...
    success: function (response) {
      alert("anda sudah mendaftar! Bagus!");
